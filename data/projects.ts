...
export const projects: Project[] = [
  { 
    ...
    content: "Dans ce projet, j'ai réalisé un montage dynamique illustrant un podcast d'URBANIA. L'objectif était de donner du rythme à l'audio par une sélection visuelle percutante. Tu pourras écrire ici tous les détails de ton travail de montage, tes inspirations et le contexte de réalisation." 
  },
  { 
  ...
  { 
    ...
    title: "Portraits Studio Photographiques", 
    category: "Photo", 
    date: "2025", 
    image: "📸", 
    shortDescription: "Série de portraits réalisés en studio pour s'entraîner avec différentes lumières.",
    content: "Projet photographique visant à maîtriser le réglage professionnel des lumières de studio (lumière principale, secondaire, de fond, etc). L'objectif était de réussir à bien détourer et éclairer les sujets."
  },
];
